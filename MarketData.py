...
class MarketData:
    ...
    def updateHistoricalData(self):
        candles=self.client.get_klines(symbol=self.inputInformation.coinSymbol.upper(), 
        ...
        self.historicalData.columns=['open','high','low','close',
    ...
    def getCandlesBetweenDates(self,coin,timeInterval , dateTime1, dateTime2):
        ...
        candles=self.client.get_historical_klines(symbol=coin, 
        ...
        backtestFormatData.columns=['open','high','low','close',
                                    'volume','close_time','asset_volume',
                                    'trade_number','taker_buy_base','taker_buy_quote']        
